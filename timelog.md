...
* *2 hours* Watch some YouTube videos on remote trackpad.
...
* *5 hours* Research on prototype tasks for different interaction techniques.

### 14th Oct 2020
* *2 hours* Read some papers based on comparison of interaction techniques
* *1 hour* Read a paper and wrote summary on SmartCasting (3D interaction)
...
### 20th Oct 2020
* *1 hours* Organized minutes from the meeting and planned rough milestones for this week.
* *3 hour* Implementing basics for a trackball
* *2 hours* Fixing continuous message passing error

### 21st Oct 2020
* *5 hours* Fixed message sending bug by implementing a background service
* *3 hour* Fixing error regarding mapping phone coordinates to laptop screen coordinates
...
### 25th Oct 2020
* *1 hours* Reading research papers and writing Level-1 summaries.
...
* *1/2 hour* Meeting with supervisor
* *1 hour* Organized minutes of the meeting and planned rough milestones for the week
* *1 hour* Read a research paper and wrote level-1 summary on pointing interaction technique
* *2 hour* Research on ray casting and calibrating phone pointer on laptop screen
...
###7th Nov 2020
* *3 hours* Implementing manipulation of 3D model using smartphone.
...
###9th Nov 2020
* *1 hour* Prepared a meeting agenda and questions to ask during the meeting
* *2 hours* Wrote dissertation report and prepared demo for presenting to supervisor.
...
###18th Nov 2020
* *2 hour* Writing last part of chapter 2
* *2 hours* Proof reading and correcting changes of the report

###19th Nov 2020
* *4 hours* Fixing the error of switching mode in 3D interaction task 
...
###9th Dec 2020
* *3 hours* Researched on the design of the final experiment task 
